...
function CV() {
  ...
  return (
    <div className="mx-auto max-w-[1400px] px-6 py-16 md:px-12">
      <FadeIn>
        <div className="rounded-2xl border border-border/50 bg-card/70 p-6 backdrop-blur-md md:p-10">
          <Link
            to="/"
...
function InfoCard({
  ...
  return (
    <section className="rounded-2xl border border-border/50 bg-card/70 p-6 backdrop-blur-md md:p-8">
